...
Undra is built using an AI-native architecture. The interactive assistant layer is powered by the **Gemini 3.6 Flash** model via the official **Google GenAI SDK** (`google-genai` Python library). The supported models used by the project are `gemini-3.6-flash` and `gemini-3.1-pro-preview`.
...
The total actual recorded expenditure in the project ledger is $7.52 USD for Gemini API LLM usage, with $0.00 USD recorded for all other operational categories.
...
|---|---|---|---|
| **Gemini API LLM Usage** | Multimodal reasoning and planning queries | $7.52 USD | Prepaid Balance |
| **Other operational expenses** | Web application hosting, domain registration, and infrastructure costs | $0.00 USD | None recorded |
| **Total recorded spend** | Combined actual recorded expenditure to date | $7.52 USD | Human Personal Funding |

---

### 2.2 Arms-Length Revenue Breakdown (May – August 2026)
Project operations commenced on 2026-08-06. May&nbsp;2026, June&nbsp;2026, and July&nbsp;2026 precede the start of the project (no ledger rows exist for those months).

The monthly breakdown is detailed below:

| Month | Arms-Length Revenue (USD) | Explanation |
|---|---|---|
| **May&nbsp;2026** | $0.00 | Precedes project start on 2026-08-06 (no ledger rows exist). |
| **June&nbsp;2026** | $0.00 | Precedes project start on 2026-08-06 (no ledger rows exist). |
| **July&nbsp;2026** | $0.00 | Precedes project start on 2026-08-06 (no ledger rows exist). |
...
- **Personal Funding**: All actual recorded costs (such as prepaid Gemini API usage) were funded directly by the human Operator (Eliza Zadura) as personal development expenditures, with no external corporate sponsors or related-party funding.
